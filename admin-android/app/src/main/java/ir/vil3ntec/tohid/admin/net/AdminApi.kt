...
class AdminApi private constructor(
  ...
  companion object {
     ...
     *
     *  ۱۰۰.۶۴ تا ۱۰۰.۱۲۷ هم اینجاست (RFC 6598). این همان نشانی‌ای است که
     *  یک شبکهٔ خصوصیِ مجازی مثل Tailscale به دستگاه‌ها می‌دهد — نشانی‌ای
     *  که عوض نمی‌شود و از هر جای دنیا همان است. برای صاحبِ سامانه‌ای که
     *  دامنه ندارد، این تنها راهِ داشتنِ نشانیِ ثابتِ رایگان است، و چون
     *  خودِ آن شبکه رمزنگاری‌شده است، http رویش روی خطِ باز نمی‌رود.
     */
