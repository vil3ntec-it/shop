...
class AuthRepository(
   ...
   *
   *  ⚠️ **صفحهٔ ورود دیگر این را صدا نمی‌زند، و نباید بزند.**
   *
   *  تا دیروز ردیفِ «ورودِ سریع» توکنِ تازه‌سازی را — رمزنشده، کنارِ نامِ
   *  حساب — روی گوشی نگه می‌داشت تا همین تابع را با آن صدا بزند. یعنی
   *  «خروج از حساب» یک کلیدِ زندهٔ نودروزه جا می‌گذاشت. شرحش سرِ
   *  `SavedLogins`.
   *
   *  خودِ این تابع سالم است و سرِ جایش می‌ماند: برگرداندنِ نشست از روی
   *  توکنی که **همین حالا** در حافظهٔ رمزشده هست، کارِ درستی است. آنچه
   *  غلط بود، نگه داشتنِ آن توکن **پس از خروج** بود. اگر روزی دوباره به
   *  کارش گرفتید، توکن را از `TokenStore` بگیرید، نه از فهرستِ حساب‌ها.
   */
