...
sealed class ApiFailure(
  ...
  companion object {
    ...
    private fun known(code: String): String? = when (code) {
      "not_found" -> "سرورِ شما قدیمی است و این بخش را ندارد. نسخهٔ تازهٔ سرور را بالا بیاورید."
      ...
      "register_ticket_invalid" -> "مهلت ثبت‌نام تمام شد — از گام اول دوباره شروع کنید"
      "terms_required" -> "برای ساختن حساب باید شرایط و ضوابط را بپذیرید"
      "password_mismatch" -> "رمز و تکرارش یکی نیست"
